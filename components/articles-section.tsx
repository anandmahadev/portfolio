          ...
          <div className="group bg-white border-[3px] border-black rounded-3xl overflow-hidden hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-all duration-300">
            ...
            <div className="p-6 md:p-8">
              <h3 className="text-xl md:text-2xl font-bold mb-4 md:mb-6">
                The AI-First PM: How the role is evolving from execution to high-level strategy in 2025
              </h3>
              <div className="flex items-center gap-3 md:gap-4">
                ...
                <div>
                  <div className="font-bold text-base md:text-lg text-[#0B0B0B]">Anand Mahadev</div>
                  <div className="text-sm md:text-base text-gray-600">March 31, 2026</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6 md:space-y-8">
              ...
              <div className="flex flex-col sm:flex-row">
                ...
                <div className="p-6 md:p-10 flex flex-col justify-center">
                  <h3 className="text-lg md:text-2xl font-bold mb-3 md:mb-4">
                    Spotify & Netflix: How AI-driven personalization changed user retention forever
                  </h3>
                  <p className="text-gray-600 text-sm md:text-lg leading-relaxed">
                    Analyzing the algorithms that drive 2B+ listening hours and keep millions of users subscribed.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="group bg-white border-[3px] border-black rounded-3xl overflow-hidden hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-all duration-300">
              <div className="flex flex-col sm:flex-row">
                ...
                <div className="p-6 md:p-10 flex flex-col justify-center">
                  <h3 className="text-lg md:text-2xl font-bold mb-3 md:mb-4">
                    Data vs Intuition: Why Predictive Analytics is now the PM's best investigative tool
                  </h3>
                  <p className="text-gray-600 text-sm md:text-lg leading-relaxed">
                    How high-performing teams are using predictive modeling to anticipate market shifts before they happen.
                  </p>
                </div>
              </div>
            </div>
