              ...
              <div className="flex flex-col sm:flex-row">
                ...
                <div className="p-6 md:p-10 flex flex-col justify-center">
                  ...
                  <p className="text-gray-600 text-sm md:text-lg leading-relaxed">
                    A comprehensive guide to choosing the right typography scale for your digital products and
                    interfaces.
                  </p>
                </div>
              </div>
            ...
            <div className="group bg-white border-[3px] border-black rounded-3xl overflow-hidden hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-all duration-300">
              <div className="flex flex-col sm:flex-row">
                ...
                <div className="p-6 md:p-10 flex flex-col justify-center">
                  ...
                  <p className="text-gray-600 text-sm md:text-lg leading-relaxed">
                    Master essential design skills with hands-on exercises that will accelerate your journey to becoming
                    a professional.
                  </p>
                </div>
              </div>
